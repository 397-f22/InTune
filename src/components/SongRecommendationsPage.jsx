...
import { weatherTypeToIcon } from '../utilities/Assets';
...
const SongRecommendationsPage = ({ weather, setWeather, weatherIcon, autoGeneratedWeather, city }) => {
  ...
  return (songs.length === 0)
    ? <div className='filler-text'><img src={loading} className='loading-gif'/></div>
    : (
      <>
        <div>
          <div className='upper-section'>
            ...
            <div className="user-metadata">
              ...
              <img className="weather-icon" src={weatherIconUrl} alt="Weather Icon"/>
            </div>
